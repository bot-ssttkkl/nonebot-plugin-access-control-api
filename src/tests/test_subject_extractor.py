...
async def test_subject_extractor(app: App):
    ...
    from nonebot_plugin_access_control_api.subject import add_subject_extractor, extract_subjects
    ...
    def extractor_b(event: Event, manager: SubjectManager):
        manager.insert_before("eventname", SubjectModel(event.get_user_id(), "extractor_b", "userid"))
